...
RANK_NORMALIZE = {
    ...
    # I-nori 직급(매니저/관장 등)은 이사님 의사결정 후 추가 예정
}
...
TEST_ACCOUNT_USERNOS = ["007", "484", "492", "493", "503", "514", "515", "527", "538", "556"]
# 007: 마스터관리자        484: 연구소업무활동        492: 구성원1(a@ezpmp.co.kr)
# 493: pm1(b@ezpmp.co.kr) 503: 연구소 구성원 테스트   514: 마스터관리자2
# 515: 조민경(중복/미래입사) 527: 신규임원(사업부장)OT용  538: 엑셀6(exel6@ezpmp.co.kr)
# 556: AXDX 테스트 계정
